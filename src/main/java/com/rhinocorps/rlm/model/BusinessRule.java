...
import com.rhinocorps.rlm.data.RuleType;
...
public class BusinessRule extends EntityBase implements Serializable {
	...
	public String getWhenAbbrv() {
		return StringUtils.abbreviate(this.when, Constants.ABBRV_DESC_LEN);
	}
	...
	public String getThenAbbrv() {
		return StringUtils.abbreviate(this.then, Constants.ABBRV_DESC_LEN);
	}
